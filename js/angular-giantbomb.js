	...
	angular.module('ngGiantBomb', ['ngResource']).
		...
		var GiantBomb = {
		    ...
		    gameSearch : function(searchString, callback){
			    $resource('http://www.giantbomb.com/api/search?resources=game&field_list=name,original_release_date,api_detail_url,site_detail_url&format=jsonp&json_callback=JSON_CALLBACK',
			        {
								query:  searchString,
			          api_key: this._apiKey
			        },
